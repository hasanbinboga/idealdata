...
namespace Tricks
{
    class AlgoTemplate: IdealSistem
    {
        public AlgoTemplate()
        {
            /**********************************************************************
           ...
           **********************************************************************/
            ...
            #region Algo sinyali için karar ve  sinyal üret

            /******************************************************************/
            // Robot sistemlerinde de olduğu gibi sinyal üretimi için Robot'ta olduğu gibi karar verilmesi gereklidir.
            ...
            /*******************************************************************/
            // Karar verirken zaman ile ilgili koşulları da hesaplamaya dahil edebilirsiniz.
            // Örneğin iki tarih aralığında  ve gün içerisinde belirtilen saat aralığında 
            // koşulu ile işlem yapmak için aşağıdaki gibi bir koşul tanımlayabiliriz.
            if (Sistem.TarihAraligi("2013.06.10", "2013.06.17")) // tarih aralığındaysa
            {
                if (Sistem.SaatAraligi("00:00", "15:30")) // saat aralığındaysa
                {
                    Sistem.AlgoIslem = "OK";
                }
            }
            ...
            /******************************************************************/
                // Verilen karara göre sinyal üretmek için aşağıdaki Sistem değerleri kullanılır.
                // Bunun için Sistem.AlgoIslem özelliği kullanılır.
                // Algo Sistemlerinde, oluşturduğunuz şart gerçekleştiğinde Algoya bağladığınız emirin iletilmesi sağlar.
                // Alabileceği değerler şunlardır;

            Sistem.AlgoIslem = "OK"; // -> Pozisyon Kapat Sinyali
            Sistem.AlgoIslem = "A";  // -> Alım Sinyali
            Sistem.AlgoIslem = "S";  // -> Satış Sinyali

            //Algo sinyalleri için  açıklama eklemek için AlgoAciklama özelliğini kullanabilirsiniz.
            Sistem.AlgoAciklama = "Açıklama Yazısı";
